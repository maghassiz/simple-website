...
// (Figma has Booking Engine, Custom Website, About Us, Pricing, and Contact Us
// as distinct pages — routes will follow once those are built).
const LINKS = [
  { label: 'Booking engine', href: '#', badge: 'New' },
